 ...
 *
 */
public class CresDisplaySurfaceCanvas implements CresDisplaySurface 
{
    CresStreamCtrl streamCtl;
    
    String TAG = "CresDisplaySurfaceCanvas";
...
// Prepare the class for destruction
    ...
    // Class constructor
    public CresDisplaySurfaceCanvas(Service app)
    {
        Log.i(TAG, "CresDisplaySurfaceCanvas" );        
    ...
    {
        Log.v(TAG, "setWindowManagerResolution - noop in canvas mode" );        
    }

    // Just remove the parentLayout
    public void RemoveView()
    {
        Log.v(TAG, "RemoveView - noop in canvas mode" );        
    }

     // Update the width and height of the surface
    public void updateWH(final int idx)
    {
    	Log.v(TAG, "UpdateWH: idx=" + idx + "  noop in canvas mode" );
    }

    // Update the X, Y location of the surface
    public void updateXY(final int idx)
    {
    	Log.v(TAG, "UpdateXY: idx=" + idx + "  noop in canvas mode" );
    }
    ...
    {
    	Log.v(TAG, "updateWindowWithVideoSize: idx=" + idx + "  noop in canvas mode" );
    }
    
    // update window for surface
    public void updateWindow(final int idx, final boolean use_texture_view)
    {
    	Log.v(TAG, "updateWindow: idx=" + idx + "  noop in canvas mode" );
    }
    ...
    {
    	Log.v(TAG, "updateWindow with x,y,w,h: idx=" + idx + "  noop in canvas mode" );
    }
    
	// invalidates parent layout
    public void forceParentLayoutInvalidation() {
    	Log.v(TAG, "forceParentLayoutInvalidation - noop in canvas mode" );
    }

    // invokes parent layout invalidation in UI thread
    public void invalidateSurface() {
    	Log.v(TAG, "invalidateSurface - noop in canvas mode" );
    }
    ...
    {
		Log.i(TAG, "GetSurfaceView(): returning null because service is in canvas mode");
    	return null;
    }
    ...
    {
		Log.i(TAG, "GetTextureView(): returning null because service is in canvas mode");
        return null;
    }
    
    public SurfaceTexture GetSurfaceTexture(int idx)
    {
		Log.i(TAG, "GetSurfaceTexture(): returning null because service is in canvas mode");
    	return null;
    }
