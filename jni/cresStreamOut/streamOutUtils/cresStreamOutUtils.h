...
//events come from jni.c to the project
    ...
    STREAMOUT_EVENT_JNI_CMD_CODEC,
    STREAMOUT_EVENT_JNI_CMD_BITRATE,
    STREAMOUT_EVENT_JNI_CMD_IFRAMEINTERVAL,
    STREAMOUT_EVENT_JNI_CMD_QUALITY,
    STREAMOUT_EVENT_JNI_CMD_HDMI_IN_RES_X,
    STREAMOUT_EVENT_JNI_CMD_HDMI_IN_RES_Y,
	...
	STREAMOUT_EVENT_JNI_CMD_RESTART_MGR,
	STREAMOUT_EVENT_JNI_CMD_RESTART_MGR_THREAD,
